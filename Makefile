...
ACLOCAL = ${SHELL} /Users/spike/svn/nesromtool/trunk/config/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
...
install_sh = /Users/spike/svn/nesromtool/trunk/config/install-sh
...
nesromtool$(EXEEXT): $(nesromtool_OBJECTS) $(nesromtool_DEPENDENCIES) 
	...
	$(LINK) $(nesromtool_LDFLAGS) $(nesromtool_OBJECTS) $(nesromtool_LDADD) $(LIBS)
...
main.o: src/main.c
	if $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT main.o -MD -MP -MF "$(DEPDIR)/main.Tpo" -c -o main.o `test -f 'src/main.c' || echo '$(srcdir)/'`src/main.c; \
...
main.obj: src/main.c
	if $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT main.obj -MD -MP -MF "$(DEPDIR)/main.Tpo" -c -o main.obj `if test -f 'src/main.c'; then $(CYGPATH_W) 'src/main.c'; else $(CYGPATH_W) '$(srcdir)/src/main.c'; fi`; \
	then mv -f "$(DEPDIR)/main.Tpo" "$(DEPDIR)/main.Po"; else rm -f "$(DEPDIR)/main.Tpo"; exit 1; fi
...
NESutils.o: src/NESutils.c
	if $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT NESutils.o -MD -MP -MF "$(DEPDIR)/NESutils.Tpo" -c -o NESutils.o `test -f 'src/NESutils.c' || echo '$(srcdir)/'`src/NESutils.c; \
	then mv -f "$(DEPDIR)/NESutils.Tpo" "$(DEPDIR)/NESutils.Po"; else rm -f "$(DEPDIR)/NESutils.Tpo"; exit 1; fi
...
NESutils.obj: src/NESutils.c
	if $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT NESutils.obj -MD -MP -MF "$(DEPDIR)/NESutils.Tpo" -c -o NESutils.obj `if test -f 'src/NESutils.c'; then $(CYGPATH_W) 'src/NESutils.c'; else $(CYGPATH_W) '$(srcdir)/src/NESutils.c'; fi`; \
	then mv -f "$(DEPDIR)/NESutils.Tpo" "$(DEPDIR)/NESutils.Po"; else rm -f "$(DEPDIR)/NESutils.Tpo"; exit 1; fi
...
functions.o: src/functions.c
	if $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT functions.o -MD -MP -MF "$(DEPDIR)/functions.Tpo" -c -o functions.o `test -f 'src/functions.c' || echo '$(srcdir)/'`src/functions.c; \
	then mv -f "$(DEPDIR)/functions.Tpo" "$(DEPDIR)/functions.Po"; else rm -f "$(DEPDIR)/functions.Tpo"; exit 1; fi
...
functions.obj: src/functions.c
	if $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT functions.obj -MD -MP -MF "$(DEPDIR)/functions.Tpo" -c -o functions.obj `if test -f 'src/functions.c'; then $(CYGPATH_W) 'src/functions.c'; else $(CYGPATH_W) '$(srcdir)/src/functions.c'; fi`; \
	then mv -f "$(DEPDIR)/functions.Tpo" "$(DEPDIR)/functions.Po"; else rm -f "$(DEPDIR)/functions.Tpo"; exit 1; fi
