...
#define ARG_SYN(ARG)		ARG ## _SYN		/* returns ARG's synonym (ARG_HELP returns ARG_HELP_SYN) */
...
#define CHECK_ARG(ARG)	strcmp(ARG, currentArg) == 0 || strcmp(ARG ## _SYN, currentArg) == 0  /* returns true if teh current argument matches ARG */
